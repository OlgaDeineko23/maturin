    ...
    !function (e) {
        ...
        if (!(e[n] && e[n].version > i)) {
            e[n] = function (e, t, n) {
                ...
                extensions: [],
                wrappers: [],
                navbar: {add: !0, title: "PARCOURIR PAR CATÉGORIES", titleLink: "parent"},
                ...
                getInstance: function () {
                    ...
                    l.$body.on(r.click + "-oncanvas", "a[href]", function (i) {
                        $('.mm-navbar')[0].style.textAlign = 'left';
                        $('.mm-navbar')[0].style.paddingLeft = '20px';
 ...
 */
    !function (e) {
        ...
        e[t].addons[n] = {
            ...
            var t = this;
            this.opts[n].blockUI && (r.$blck || (r.$blck = e('<div class="' + o.page + "__blocker " + o.slideout + '"><span aria-hidden="true">&times;</span></div>')), r.$blck.appendTo(r.$body).off(s.touchstart + "-" + n + " " + s.touchmove + "-" + n).on(s.touchstart + "-" + n + " " + s.touchmove + "-" + n, function (e) {
