$(document).ready(function () {
    ...
    $(document).on('click', 'input[type=checkbox]', function () {
        if($(this)[0].checked === true){
            var newDiv = $(' <div class="category-products-filter-by">'+$(this)[0].value+'<button class="category-products-filter-by-btn-close"><i class="fa fa-times" aria-hidden="true"></i></button></div>');
    ...
    $(document).on('click', '.category-products-filter-by-btn-close', function () {
        var parentText = $(this).parent()[0].innerText;
